...
ggplot(df3, aes(x=Date_Sampled)) + 
  geom_point(aes(y=ExchNa_ppm), color="darkturquoise") +
...
```{r}
ggplot(df3, aes(x=Date_Sampled)) + 
  geom_point(aes(y=Na_Sat_pct), color="darkturquoise") +
...
```{r}
df4 <- df3 %>% select("Date_Sampled","Year","Irr_season", "Depth_1", "Field_ID", "Soil_pH", "Buffer_pH", "Excess_Lime", "Soluble_Salts", "OM_pct", "NO3_D1_ppm", "NO3_D1_lbs_A", "Bicarb_P_ppm", "SO4_ppm", "ExchK_ppm", "ExchCa_ppm", "ExchMg_ppm", "ExchNa_ppm", "Zn_ppm", "Fe_ppm", "Mn_ppm", 'Cu_ppm', "Boron_ppm", "CEC_me_100g", "Base_Sat_pct", "H_Sat_pct", "Ca_Sat_pct", "Mg_Sat_pct", "K_Sat_pct", "Na_Sat_pct")
